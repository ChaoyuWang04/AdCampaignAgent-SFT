...
# python /root/autodl-tmp/test_qwen_infer.py --model_path /root/autodl-tmp/qwen3-0_6b_lora_v5_merged --local_files_only --show_template
    
   
# python -u /root/autodl-tmp/Agent+SFT/test_qwen_infer.py \
#   --model_path /root/autodl-tmp/Agent+SFT/qwen3-0_6b_lora_v2_last_assistant \
