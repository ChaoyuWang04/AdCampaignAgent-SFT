...
def parse_args() -> argparse.Namespace:
	...
	parser.add_argument("--data_file", type=str, default=str(processed_data_dir() / "merged_train_final.json"),help="Path to JSON/JSONL file")
	parser.add_argument("--model_name_or_path", type=str, default=str(default_model_dir()), help="Tokenizer source")
	...
	parser.add_argument("--tools_file", type=str, default=str(tools_schema_path()), help="Path to JSON file with a list of tools to inject when sample.tools is missing")
...
#   --model_name_or_path models/qwen3-0_6b \
