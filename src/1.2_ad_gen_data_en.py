...
# User roles
USER_ROLES = ["UA Manager", "Creative Lead", "Growth Lead", "Operations Manager", "Campaign Optimizer"]
...
class AdDatasetGenerator:
    ...
    def _update_progress(self):
        with self.lock:
            ...
            print(f"\rProgress: {c}/{t} ({100*c/t:.1f}%)", end="", flush=True)
    ...
    def gen_workflow2_upload(self, count: int) -> list:
        ...
        # Upload failure scenarios: validate returns non-compliant
        fail_queries = [
    ...
    def gen_workflow3_single_query(self, count: int) -> list:
        ...
        # Clarification scenarios: missing campaign_id
        ambiguous = [
        ...
        for _ in range(count):
            ...
            rec["scene_tag"] = random.choice(SCENE_TAGS[:7])  # Any ROAS/RET scene
    ...
    def gen_workflow4_deep_analysis(self, count: int) -> list:
        ...
        # User query templates customized by scene tag
        scene_query_map = {
            "healthy": [
    ...
    def gen_workflow7_refusal(self, count: int) -> list:
        ...
        refusal_templates = {
            ...
            "insufficient_data_to_answer": [
                "How's the ROAS?",             # Missing campaign_id and timeframe
    ...
    def generate(self, output_path: str = None):
        ...
        print("▶ Starting Ad Agent seed dataset generation...")
        all_records = []
        ...
        # ── Statistics ──
        print(f"\n\n✅ Generation complete, total {len(all_records)} records")
        wf_counter = {}
        scene_counter = {}
        clarify_count = 0
