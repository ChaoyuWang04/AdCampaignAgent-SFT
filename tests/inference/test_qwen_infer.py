...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model_path", type=str, default=str(default_model_dir()), help="Path to merged model dir")
...
# python tests/inference/test_qwen_infer.py --model_path models/qwen3-0_6b --local_files_only --show_template
    
   
# python -u tests/inference/test_qwen_infer.py \
#   --model_path models/qwen3-0_6b \
